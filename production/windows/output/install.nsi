...
LangString DISPLAYNAME ${LANG_TRADCHINESE} "懶狗輸入法"
LangString LNKFORMANUAL ${LANG_TRADCHINESE} "【懶狗】使用說明"
LangString LNKFORSETTING ${LANG_TRADCHINESE} "【懶狗】輸入法設定"
LangString LNKFORDICT ${LANG_TRADCHINESE} "【懶狗】用戶詞典管理"
LangString LNKFORSYNC ${LANG_TRADCHINESE} "【懶狗】用戶資料同步"
LangString LNKFORDEPLOY ${LANG_TRADCHINESE} "【懶狗】重新部署"
LangString LNKFORSERVER ${LANG_TRADCHINESE} "懶狗輸入法服務"
LangString LNKFORUSERFOLDER ${LANG_TRADCHINESE} "【懶狗】用戶文件夾"
LangString LNKFORAPPFOLDER ${LANG_TRADCHINESE} "【懶狗】程序文件夾"
LangString LNKFORUPDATER ${LANG_TRADCHINESE} "【懶狗】檢查新版本"
LangString LNKFORSETUP ${LANG_TRADCHINESE} "【懶狗】安裝選項"
LangString LNKFORUNINSTALL ${LANG_TRADCHINESE} "卸載懶狗輸入法"
LangString CONFIRMATION ${LANG_TRADCHINESE} "安裝前，請先卸載舊版本的懶狗輸入法。$\n$\n按下「確定」移除舊版本，按下「取消」放棄本次安裝。"
LangString SYSTEMVERSIONNOTOK ${LANG_TRADCHINESE} "不支援此 Windows 版本，最低系統要求：Windows 10。"
LangString AUTOCHKUPDATE ${LANG_TRADCHINESE} "自動檢查版本更新？"

!insertmacro MUI_LANGUAGE "SimpChinese"
LangString DISPLAYNAME ${LANG_SIMPCHINESE} "懒狗输入法"
LangString LNKFORMANUAL ${LANG_SIMPCHINESE} "【懒狗】使用说明"
LangString LNKFORSETTING ${LANG_SIMPCHINESE} "【懒狗】输入法设置"
LangString LNKFORDICT ${LANG_SIMPCHINESE} "【懒狗】用户词典管理"
LangString LNKFORSYNC ${LANG_SIMPCHINESE} "【懒狗】用户资料同步"
LangString LNKFORDEPLOY ${LANG_SIMPCHINESE} "【懒狗】重新部署"
LangString LNKFORSERVER ${LANG_SIMPCHINESE} "懒狗输入法服务"
LangString LNKFORUSERFOLDER ${LANG_SIMPCHINESE} "【懒狗】用户文件夹"
LangString LNKFORAPPFOLDER ${LANG_SIMPCHINESE} "【懒狗】程序文件夹"
LangString LNKFORUPDATER ${LANG_SIMPCHINESE} "【懒狗】检查新版本"
LangString LNKFORSETUP ${LANG_SIMPCHINESE} "【懒狗】安装选项"
LangString LNKFORUNINSTALL ${LANG_SIMPCHINESE} "卸载懒狗输入法"
LangString CONFIRMATION ${LANG_SIMPCHINESE} '安装前，请先卸载旧版本的懒狗输入法。$\n$\n点击 "确定" 移除旧版本，或点击 "取消" 放弃本次安装。'
LangString SYSTEMVERSIONNOTOK ${LANG_SIMPCHINESE} "不支持此 Windows 版本，最低系统要求：Windows 10。"
LangString AUTOCHKUPDATE ${LANG_SIMPCHINESE} "自动检查版本更新？"

!insertmacro MUI_LANGUAGE "English"
LangString DISPLAYNAME ${LANG_ENGLISH} "Langou Input Method"
LangString LNKFORMANUAL ${LANG_ENGLISH} "Langou User Guide"
LangString LNKFORSETTING ${LANG_ENGLISH} "Langou Settings"
LangString LNKFORDICT ${LANG_ENGLISH} "Langou Dictionary Manager"
LangString LNKFORSYNC ${LANG_ENGLISH} "Langou Sync User Profile"
LangString LNKFORDEPLOY ${LANG_ENGLISH} "Redeploy Langou"
LangString LNKFORSERVER ${LANG_ENGLISH} "Langou Input Method Service"
LangString LNKFORUSERFOLDER ${LANG_ENGLISH} "Langou User Folder"
LangString LNKFORAPPFOLDER ${LANG_ENGLISH} "Langou App Folder"
LangString LNKFORUPDATER ${LANG_ENGLISH} "Check for Langou Updates"
LangString LNKFORSETUP ${LANG_ENGLISH} "Langou Installation Options"
LangString LNKFORUNINSTALL ${LANG_ENGLISH} "Uninstall Langou Input Method"
LangString CONFIRMATION ${LANG_ENGLISH} "Before installation, please uninstall the old version of Langou Input Method.$\n$\nPress 'OK' to remove the old version, or 'Cancel' to abort installation."
LangString SYSTEMVERSIONNOTOK ${LANG_ENGLISH} "This Windows version is not supported. Minimum supported system: Windows 10."
...
program_files:
  ...
  WriteRegStr HKLM "${REG_UNINST_KEY}" "Publisher" "Langou IME Contributors"
  WriteRegStr HKLM "${REG_UNINST_KEY}" "URLInfoAbout" "https://langou.tech/"
  WriteRegStr HKLM "${REG_UNINST_KEY}" "HelpLink" "https://langou.tech/"
