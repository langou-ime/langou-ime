...
import com.osfans.trime.util.yaml.stringList
...
data class GeneralStyle(
    ...
    companion object {
        fun decode(node: Node): GeneralStyle = GeneralStyle(
            ...
            candidateFont = node["candidate_font"]?.stringList ?: emptyList(),
            ...
            commentFont = node["comment_font"]?.stringList ?: emptyList(),
            ...
            hanbFont = node["hanb_font"]?.stringList ?: emptyList(),
            ...
            keyFont = node["key_font"]?.stringList ?: emptyList(),
            ...
            labelFont = node["label_font"]?.stringList ?: emptyList(),
            latinFont = node["latin_font"]?.stringList ?: emptyList(),
            ...
            popupFont = node["popup_font"]?.stringList ?: emptyList(),
            ...
            symbolFont = node["symbol_font"]?.stringList ?: emptyList(),
            symbolTextSize = node["symbol_text_size"]?.float ?: 0f,
            textFont = node["text_font"]?.stringList ?: emptyList(),
